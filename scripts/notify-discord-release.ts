  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new Androdex prerelease is available for nightly testers."
          : "A new Androdex latest release is available.",
...
).pipe(Command.withDescription("Post a Androdex release announcement to Discord."));
