...
const PATH_CAPTURE_START = "__ANDRODEX_PATH_START__";
const PATH_CAPTURE_END = "__ANDRODEX_PATH_END__";
...
function envCaptureStart(name: string): string {
  return `__ANDRODEX_ENV_${name}_START__`;
}

function envCaptureEnd(name: string): string {
  return `__ANDRODEX_ENV_${name}_END__`;
}
