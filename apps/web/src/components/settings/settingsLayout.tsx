...
export function SettingsSection({
  ...
  return (
    <section {...sectionProps} className={cn("space-y-2.5", className)}>
      ...
      <div className="relative overflow-hidden rounded-lg border bg-card text-card-foreground shadow-[0_1px_2px_rgb(0_0_0_/_0.04)] not-dark:bg-clip-padding before:pointer-events-none before:absolute before:inset-0 before:rounded-[calc(var(--radius-lg)-1px)] before:shadow-[0_1px_--theme(--color-black/3%)] dark:shadow-none dark:before:shadow-[0_-1px_--theme(--color-white/5%)]">
        {children}
      </div>
    </section>
  );
