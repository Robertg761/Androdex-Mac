import type { EnvironmentId, MessageId, OrchestrationMessage } from "@t3tools/contracts";
...
export function buildMessageSlice(thread: { messages: ReadonlyArray<ChatMessage> }): {
  ids: MessageId[];
