...
import { resolveRemoteAndrodexCliPackageSpec } from "@t3tools/ssh/command";
import type { RemoteAndrodexRunnerOptions } from "@t3tools/ssh/tunnel";
...
const resolveDesktopSshCliRunner = (
  ...
  return {
    packageSpec: resolveRemoteAndrodexCliPackageSpec({
