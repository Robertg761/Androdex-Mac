// This file mostly exists because we want dev mode to say "Androdex (Dev)" instead of "electron"
...
const APP_DISPLAY_NAME = isDevelopment ? "Androdex (Dev)" : "Androdex (Alpha)";
const APP_BUNDLE_ID = isDevelopment ? "xyz.androdex.desktop.dev" : "xyz.androdex.desktop";
