...
const makeCheckpointStore = Effect.gen(function* () {
  ...
  const captureCheckpoint: CheckpointStoreShape["captureCheckpoint"] = Effect.fn(
    ...
    yield* Effect.acquireUseRelease(
      fs.makeTempDirectory({ prefix: "androdex-fs-checkpoint-" }),
      Effect.fn("captureCheckpoint.withTempDirectory")(function* (tempDir) {
        ...
        const commitEnv: NodeJS.ProcessEnv = {
          ...
          GIT_AUTHOR_NAME: "Androdex",
          GIT_AUTHOR_EMAIL: "androdex@users.noreply.github.com",
          GIT_COMMITTER_NAME: "Androdex",
          GIT_COMMITTER_EMAIL: "androdex@users.noreply.github.com",
        };
        ...
        const message = `androdex checkpoint ref=${input.checkpointRef}`;
